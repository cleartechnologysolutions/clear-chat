# Chat Build 9 — inline image messages
...
5. Reload Chat and look for **Build 9**. Choose Attach image or paste into the message box, optionally enter a caption, then Send. A preview appears before sending. Nothing uploads until Send.
